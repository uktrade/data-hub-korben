...
from korben.cdms_api.rest.fields import StringField, IntegerField, DateTimeField, BooleanField, IdRefField, ForeignKeyField
...
class ForeignKeyFieldTestCase(TestCase):
    ...
    @mock.patch('korben.cdms_api.rest.fields.apps')
