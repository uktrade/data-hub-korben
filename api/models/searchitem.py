class SearchItem(object):
    def __init__(self, source_id, result_source, result_type, title,
    ...
    class Meta:
        ...
        es_mapping = {
            'properties': {
                ...
                'result_type': {'type': 'string', 'index': 'no'},
                ...
                'alt_address_postcode': {'type': 'string', 'index': 'not_analyzed'},
                'company_number': {'type': 'string', 'index': 'not_analyzed'},
