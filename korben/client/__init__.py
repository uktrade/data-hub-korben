'''
CRUD functions for single objects that either (in the case of read) call sync
and ETL code to bring in fresh CDMS data or (in the case of write) call
“reverse ETL” code to send data to CDMS.

Functions here run through required CDMS operations and then (in the case of
success) call Django methods.
'''
